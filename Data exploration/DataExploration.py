...
class DataExploration:
    ...
    def create_lmplot(self,variables_of_interest,variable_of_interest_x,variable_of_interest_y):
        plt.figure('lmplot')
        data_lmplot = self.data.loc[:,variables_of_interest]
        print(data_lmplot)
        sns.lmplot(variable_of_interest_x,variable_of_interest_y,data=data_lmplot,fit_reg=False)
